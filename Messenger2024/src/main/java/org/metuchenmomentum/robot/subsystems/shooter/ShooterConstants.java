...
public class ShooterConstants {
    ...
    public static final double kAmpShootingSpeed = 0.5;
    ...
    public static final double kShooterPivotDownSpeed = -0.5;
    public static final double kShooterPivotUpSpeed = 0.5;

    public static final double kNeutralPosition = 0;
    public static final double kHandoffPosition = 45;
