...
public final class Constants {
  ...
  public static final PathConstraints kPathConstraints =
      new PathConstraints(
          kMaxSpeed, kMaxAccelerationMetersPerSecondSquared,
          kMaxAngularSpeedRadiansPerSecond, kMaxAngularSpeedRadiansPerSecondSquared);
  ...
  public static final double kTranslationD = 0.0;
    ...
    public static final class ModuleConstants {
        ...
        public static final double kDrivingMotorFreeSpeedRps = MotorConstants.kFreeSpeed / 60;
        ...
        public static final double kDrivingEncoderPositionFactor = (kWheelDiameterMeters * Math.PI) / kDrivingMotorReduction; // m
        public static final double kDrivingEncoderVelocityFactor = ((kWheelDiameterMeters * Math.PI) / kDrivingMotorReduction) / 60.0; // m/s
